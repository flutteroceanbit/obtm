...
import 'custom_adaptive_layout.dart';
import 'custom_breakpoints.dart';
import 'custom_navigation_rail.dart' as navigation_rail;
import 'custom_slot_layout.dart';
...
class AdaptiveScaffold extends StatefulWidget {
  ...
  const AdaptiveScaffold({
    ...
    this.trailingUnExtendedNavRail,
    this.smallBody,
    this.body,
    this.largeBody,
    ...
    this.onSelectedIndexChangeForCloseDrawer,
    this.useDrawer = true,
  ...
  /// [navigation_rail.NavigationRailDestination]s and [BottomNavigationBarItem]s and inserted
  /// into the appropriate places. If passing destinations, you must also pass a
  /// selected index to be used by the [navigation_rail.NavigationRail].
  ...
  final Widget? trailingUnExtendedNavRail;
  ...
  ///Sets the drawer background color. default color is [Colors.white]
  ...
  ///Callback function for when the index of a [NavigationRail] changes and close drawer after select item
  final Function(int)? onSelectedIndexChangeForCloseDrawer;
  ...
  /// Public helper method to be used for creating a [navigation_rail.NavigationRailDestination] from
  /// a [NavigationDestination].
  static navigation_rail.NavigationRailDestination toRailDestination(
    NavigationDestination destination,
  ) {
    return navigation_rail.NavigationRailDestination(
  ...
  static Builder standardNavigationRail({
    required List<navigation_rail.NavigationRailDestination> destinations,
    double width = 72,
    int? selectedIndex,
    bool extended = false,
    ...
    IconThemeData selectedIconTheme = const IconThemeData(color: Colors.white),
    IconThemeData unselectedIconTheme = const IconThemeData(
      color: Colors.black,
    ),
    TextStyle selectedLabelTextStyle = const TextStyle(color: Colors.white),
    TextStyle unselectedLabelTextStyle = const TextStyle(color: Colors.black),
            ...
            builder: (BuildContext context, BoxConstraints constraints) {
              return ConstrainedBox(
                ...
                child: IntrinsicHeight(
                  child: navigation_rail.NavigationRail(
                    // labelType: labelType,
                    elevation: 4,
                    leading: leading,
                    trailing: trailing,
      ...
      child: Scaffold(
        ...
        drawer: widget.drawerBreakpoint.isActive(context) && widget.useDrawer
            ? Drawer(
                ...
                child: navigation_rail.NavigationRail(
                  elevation: 4,
                  selectedLabelTextStyle: Constant.textStyleSize20(
                    context,
                  )?.copyWith(color: Constant.cWhite),
                  unselectedLabelTextStyle: Constant.textStyleSize20(
                    context,
                  ...
                  onDestinationSelected:
                      widget.drawerBreakpoint.isActive(context) &&
                          widget.useDrawer
                      ? widget.onSelectedIndexChangeForCloseDrawer
            ...
            config: <Breakpoint, SlotLayoutConfig>{
              widget.mediumBreakpoint: SlotLayout.from(
                ...
                builder: (_) => AdaptiveScaffold.standardNavigationRail(
                  ...
                  trailing: widget.trailingUnExtendedNavRail,
                  selectedIndex: widget.selectedIndex,
