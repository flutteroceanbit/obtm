...
class Breakpoints {
  ...
  static const Breakpoint mediumAndUp = WidthPlatformBreakpoint(begin: 660);

  /// A desktop window whose width is between 600 dp and 840 dp.
  static const Breakpoint mediumDesktop =
  WidthPlatformBreakpoint(begin: 600, end: 1000, platform: _desktop);
  ...
  WidthPlatformBreakpoint(begin: 1000, platform: _desktop);
