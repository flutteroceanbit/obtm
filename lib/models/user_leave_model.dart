class GetUserLeave {
  ...
  factory GetUserLeave.fromJson(Map<String, dynamic> json) => GetUserLeave(
        status: json["status"],
...
class LeaveBalance {
  ...
  factory LeaveBalance.fromJson(Map<String, dynamic> json) => LeaveBalance(
        id: json["id"],
        userId: json["user_id"],
        masterLeavesId: json["master_leaves_id"],
        totalLeaves: json["total_leaves"],
        usedLeaves: json["used_leaves"]?.toDouble(),
        remainingLeaves: json["remaining_leaves"]?.toDouble(),
        year: json["year"],
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        deletedAt: json["deleted_at"],
