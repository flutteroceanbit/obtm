class GetHolidayByMonth {
  bool status;
  String message;
  List<HolidayInMonth> data;
  ...
  factory GetHolidayByMonth.fromJson(Map<String, dynamic> json) =>
      GetHolidayByMonth(
        status: json["status"],
        message: json["message"],
        data: List<HolidayInMonth>.from(
            json["data"].map((x) => HolidayInMonth.fromJson(x))),
      );
...
class HolidayInMonth {
  ...
  factory HolidayInMonth.fromJson(Map<String, dynamic> json) => HolidayInMonth(
        id: json["id"],
