...
import 'package:oceanbit_timeclock/screen/profile/widgets/chart_widget/src/extensions/color_extension.dart';
...
class BarChartData extends AxisChartData  {
  ...
  BarChartData({
    ...
    ExtraLinesData? extraLinesData,
        ...
        barTouchData = barTouchData ?? BarTouchData(enabled: false),
        super(
...
class BarTouchTooltipData with EquatableMixin {
  ...
  })  : tooltipBgColor = tooltipBgColor ?? Colors.transparent,//Colors.blueGrey.darken(15),
