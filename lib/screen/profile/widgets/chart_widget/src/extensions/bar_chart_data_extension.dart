import '../chart/bar_chart/bar_chart_data.dart';

extension BarChartDataExtension on BarChartData {
  List<double> calculateGroupsX(double viewWidth) {
    assert(barGroups.isNotEmpty);
    final groupsX = List<double>.filled(barGroups.length, 0,growable: true);
    switch (alignment) {
      case BarChartAlignment.start:
        final horizontalMargin =groupsSpace;//(sumWidth/2);
