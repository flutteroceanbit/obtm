...
import 'package:oceanbit_timeclock/screen/admin_screens/admin_system_fault_screen.dart';
import 'package:oceanbit_timeclock/screen/admin_screens/employee_screen/admin_salary_screen.dart';
import 'package:oceanbit_timeclock/screen/admin_screens/employee_screen/past_employee.dart';
...
class MediumBodyWidget extends StatefulWidget {
  const MediumBodyWidget({
    Key? key,
  ...
  @override
  State<MediumBodyWidget> createState() => _MediumBodyWidgetState();
}

class _MediumBodyWidgetState extends State<MediumBodyWidget> {
  @override
